...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    // 使用MT(Moller Trumbore)算法求光线与三角形的交点
    double u, v, t_tmp = 0;
    ...
    // b1, b2 > 0，且 b1 + b2 < 1 (三角形重心概念)

    // t 是光线射出多久后到达相交点，得是非负的
    ...
    // 法向量
    inter.normal = normal;
    // 交点，因为光线和三角面与t_tmp时间后相交，所以光线在t_tmp时间的位置即是交点
    inter.coords = ray(t_tmp);
    // 与光线相交的物体，即是当前的三角形
    inter.obj = this;
    // 相交物体的材质，在初始化该三角形时会给定
    inter.m = m;
